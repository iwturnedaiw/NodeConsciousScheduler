...
public class Constants {
    ...
    static String ARRIVAL_RESOURCES_PER_DAY_OUTPUT = "arrival_resources_day.out";
    static String ARRIVAL_RESOURCES_PER_HOUR_OUTPUT = "arrival_resources_hour.out";
    static String ARRIVAL_RESOURCES_PER_MINUTE_OUTPUT = "arrival_resources_minute.out";  
    ...
    static String ARRIVAL_MEMORY_RESOURCES_PER_DAY_OUTPUT = "arrival_memory_resources_day.out";
    static String ARRIVAL_MEMORY_RESOURCES_PER_HOUR_OUTPUT = "arrival_memory_resources_hour.out";
    static String ARRIVAL_MEMORY_RESOURCES_PER_MINUTE_OUTPUT = "arrival_memory_resources_minute.out";
